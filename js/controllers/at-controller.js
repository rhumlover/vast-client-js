App.controller('ATCtrl', [
    '$rootScope', '$scope', '$http', 'LogService', 'PlayerService', 'UtilService', 'TesterService',
    function($rootScope, $scope, $http, Log, Player, Util, Tester)
    {
        Tester.init({
            '$scope': $scope
        });
